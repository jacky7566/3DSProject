...
namespace eDocGenLib.Utils
{
    public class MailHelper
    {
        ...
        /// 寄信標題
        /// </summary>
        static string _mailTitle;
        /// <summary>
        /// 寄信人Email
        /// </summary>
        static string _sendMail;
        /// <summary>
        /// 收信人Email(多筆用逗號隔開)
        /// </summary>
        static string _receiveMails;
        /// <summary>
        /// 寄信smtp server
        /// </summary>
        ...
        public MailHelper(IConfiguration config)
        {
            ...
            _config = config;
            //mailTitle
            _mailTitle = config["MailSettings:mailTitle"];
            //sendMail
            _sendMail = config["MailSettings:sendMail"];
            //receiveMails
            _receiveMails = config["MailSettings:receiveMails"];
            //smtpServer
        ...
        public bool SendMail(string MailFrom, List<string> MailToList, string MailSub, string MailBody, bool isBodyHtml,
